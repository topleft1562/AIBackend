...
FunctionTool.from_defaults(
    ...
    "   • Users with >3 raids in group: `{ f'groupPoints.{groupId}.raids': { '$gt': 3 } }`\n"
    "   • Users who joined this group: `{ 'groups': groupId }`\n"
    "   • Raids created after April 1: `{ 'createdAt': { '$gte': '2025-04-01T00:00:00Z' } }`\n"
