...
"  → filter={ f'groupPoints.{groupId}.invites': { '$gt': 5 } }\n"
"- Users who sent 100+ messages:\n"
"  → filter={ f'groupPoints.{groupId}.messageCount': { '$gt': 100 } }\n"
"- Users in the group:\n"
"  → filter={ 'groups': groupId }\n"
"- Leaderboard:\n"
"  → filter={ f'groupPoints.{groupId}.points': { '$gt': 0 } }, sort={ f'groupPoints.{groupId}.points': -1 }, limit=10\n"
"- Raids in progress for this group:\n"
"  → filter={ 'status': 'in_progress', 'groupId': groupId }\n"
"- Raids after April:\n"
"  → filter={ 'createdAt': { '$gte': '2025-04-01T00:00:00Z' } }\n"
"- Top 5 projects by member count:\n"
"  → filter={ 'stats.memberCount': { '$gt': 0 } }, sort={ 'stats.memberCount': -1 }, limit=5\n\n"
