...
def handle_dispatch():
    ...
    "\n"
    "Your goal is to list EVERY possible valid route (any order, no repeats) that:\n"
    ...
    "- Only include routes where Loaded % is at least 70%.\n"
    "\n"
    ...
    "- The sequence of city steps (use <span style='color:green'> for loaded segments and <span style='color:red'> for empty segments), the load_ids (in order), total loaded km, total empty km, loaded %, total km, total revenue, and RPM ($/mile).\n"
