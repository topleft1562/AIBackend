...
def handle_dispatch():
    ...
    try:
        ...
        prompt = (
            ...
            "- For each route, show the pickup and drop off cities in sequence including start and end points (brandon => winnipeg -> winnipeg => neepawa -> gladstone => brandon), the loaded km, empty km, loaded %, total km, total revenue, and RPM ($/mile).\n"
